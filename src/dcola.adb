package body dcola is
   ...
   begin  
      return qu.q.sig = null; -- si el primer nodo apunta a null querrá decir que es el último,
                              -- por tanto el único en la cola                             
   exception 
         when constraint_error => raise mal_uso; -- si la pila está vacía : error
   end is_last_item;
